 ...
 * Однако не всегда компилятор может это сделать, т.к. фактический объект, находящийся по ссылке b, на момент компиляции
 * не известен. Поэтому иногда такой код может успешно скомпилироваться, но упасть с ошибкой во время исполнения.
 *
